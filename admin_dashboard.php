               ...
               <div class="topbar">
                  <nav class="navbar navbar-expand-lg navbar-light">
                     <div class="full">
                        ...
                        <div class="logo_section">
                           <a href="admin_dashboard.html"><img class="img-responsive" src="images/logo/logo-verywell.jpg" alt="#" /></a>
                        </div>
                        <div class="right_topbar">
                           <div class="icon_info">
                              <ul class="user_profile_dd">
                                 <li>
                                    <a class="dropdown-toggle" data-toggle="dropdown"><img class="img-responsive rounded-circle" src="pro.png" alt="#" /><span class="name_user">Admin</span></a>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    echo "<td><img src='{$row['image_url']}' alt='Product Image' style='max-width: 100px; max-height: 100px;' class='img-thumbnail'></td>";
                    echo "<td>
...
<style>
    ...
    table.table {
        width: 100%;
        margin-bottom: 20px;
        border: 2px solid #4169e1; /* Royal Blue border for the table */
        border-radius: 10px;
        overflow: hidden;
    }
    ...
    table.table th {
        background-color: #4169e1; /* Royal Blue color for header cells */
        color: #ffffff; /* White color for text in header cells */
    }

    table.table tbody tr:nth-child(even) {
        background-color: #f0f8ff; /* Alice Blue color for even rows */
    }

    .img-thumbnail {
        border: 2px solid #4169e1; /* Royal Blue border for the product images */
    }

    .btn-success, .btn-danger {
        background-color: #4169e1; /* Royal Blue color for buttons */
        border: none;
    }

    .btn-success:hover, .btn-danger:hover {
        background-color: #001f3f; /* Dark Blue color on hover */
    }
body {
            overflow: auto;
        }
